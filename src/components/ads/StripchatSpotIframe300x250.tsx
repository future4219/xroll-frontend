...
export function StripchatSpotIframe300x250() {
  ...
  return (
    <div className="relative h-[250px] w-[300px] overflow-hidden rounded-xl bg-black">
      ...
      {/* ✅ LIVEタグ（左下） */}
      <div className="pointer-events-none absolute right-4 bottom-1 z-30 flex items-center gap-2">
        <span className="rounded-md bg-gradient-to-r from-pink-500 to-red-600 px-2 py-1 text-[11px] font-extrabold tracking-wide text-white shadow">
          LIVE
        </span>
